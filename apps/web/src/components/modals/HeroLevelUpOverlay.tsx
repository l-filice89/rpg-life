...
import { Button, SkillChip, XpBar } from '@rpg-life/ui';
...
export function HeroLevelUpOverlay({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-background px-7 py-10 text-foreground"
    >
      ...
      <div className="relative z-10 flex w-full max-w-sm flex-col items-center gap-8">
        <div className="text-center">
          ...
          <h1 id="level-up-heading" className="text-display-sm font-extrabold">
            Level up!
          </h1>
        ...
        <Button
          type="button"
          className="min-h-[44px] w-full max-w-sm"
          onClick={onContinue}
        >
          Continue
        </Button>
